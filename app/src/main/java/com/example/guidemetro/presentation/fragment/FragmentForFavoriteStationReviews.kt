...
class FragmentForFavoriteStationReviews : Fragment() {
    ...
    companion object {
        fun newInstance(stationName: String): FragmentForFavoriteStationReviews {
            val fragment = FragmentForFavoriteStationReviews()
